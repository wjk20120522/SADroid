...
DVM_PERMISSIONS_BY_PERMISSION = {
    'BIND_DEVICE_ADMIN': {'Landroid/app/admin/DeviceAdminReceiver;': [('C'
                          ...
                          'Ljava/lang/String;')],
                          'Landroid/app/admin/DevicePolicyManager;': [('F'
                          , 'getRemoveWarning',
                          ...
                          'setActivePasswordState', '(I I)')],
                          'Landroid/app/admin/IDevicePolicyManager$Stub$Proxy;': [('F'
                          , 'getRemoveWarning',
                          '(Landroid/content/ComponentName; Landroid/os/RemoteCallback;)'
                          ), ('F', 'reportFailedPasswordAttempt', '()'
                          ), ('F', 'reportSuccessfulPasswordAttempt',
                          ...
                          'setActivePasswordState', '(I I)')]},
    'READ_SYNC_SETTINGS': {
        'Landroid/app/ContextImpl$ApplicationContentResolver;': [('F',
                'getIsSyncable',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'getMasterSyncAutomatically', '()'), ('F',
                'getPeriodicSyncs',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'getSyncAutomatically',
                '(Landroid/accounts/Account; Ljava/lang/String;)')],
        'Landroid/content/ContentService;': [('F', 'getIsSyncable',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'getMasterSyncAutomatically', '()'), ('F',
                'getPeriodicSyncs',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'getSyncAutomatically',
                '(Landroid/accounts/Account; Ljava/lang/String;)')],
        'Landroid/content/ContentResolver;': [('F', 'getIsSyncable',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'getMasterSyncAutomatically', '()'), ('F',
                'getPeriodicSyncs',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'getSyncAutomatically',
                '(Landroid/accounts/Account; Ljava/lang/String;)')],
        'Landroid/content/IContentService$Stub$Proxy;': [('F',
                'getIsSyncable',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'getMasterSyncAutomatically', '()'), ('F',
                'getPeriodicSyncs',
    ...
    'FACTORY_TEST': {'Landroid/content/pm/ApplicationInfo;': [('C',
                     'FLAG_FACTORY_TEST', 'I'), ('C', 'flags', 'I')],
                     'Landroid/content/Intent;': [('C',
                     'IntentResolution', 'Ljava/lang/String;'), ('C',
                     'ACTION_FACTORY_TEST', 'Ljava/lang/String;')]},
    'SET_ALWAYS_FINISH': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                          , 'setAlwaysFinish', '(B)')]},
    'READ_CALENDAR': {
        'Landroid/provider/Calendar$CalendarAlerts;': [('F',
                'alarmExists',
                '(Landroid/content/ContentResolver; J J J)'), ('F',
                'findNextAlarmTime',
                '(Landroid/content/ContentResolver; J)'), ('F', 'query'
                ,
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin; Ljava/lang/String; [L[Ljava/lang/Strin; Ljava/lang/String;)'
                )],
        'Landroid/provider/Calendar$Calendars;': [('F', 'query',
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin; Ljava/lang/String; Ljava/lang/String;)'
                )],
        'Landroid/provider/Calendar$Events;': [('F', 'query',
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin; Ljava/lang/String; Ljava/lang/String;)'
                ), ('F', 'query',
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin;)'
                )],
        'Landroid/provider/Calendar$Instances;': [('F', 'query',
        ...
        'Landroid/provider/Calendar$EventDays;': [('F', 'query',
                '(Landroid/content/ContentResolver; I I)')],
        },
    'ACCESS_DRM': {'Landroid/provider/DrmStore;': [('F',
                   'enforceAccessDrmPermission',
                   '(Landroid/content/Context;)')]},
    'CHANGE_CONFIGURATION': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                             , 'updateConfiguration',
                             '(Landroid/content/res/Configuration;)'
                             )]},
    'SET_ACTIVITY_WATCHER': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                             , 'profileControl',
    ...
    'GET_PACKAGE_SIZE': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F'
                         , 'getPackageSizeInfo',
                         '(Ljava/lang/String; LIPackageStatsObserver;)'
                         ), ('F', 'getPackageSizeInfo',
                         '(Ljava/lang/String; Landroid/content/pm/IPackageStatsObserver;)'
                         )],
                         'Landroid/content/pm/PackageManager;': [('F',
                         'getPackageSizeInfo',
                         '(Ljava/lang/String; Landroid/content/pm/IPackageStatsObserver;)'
                         )]},
    'CONTROL_LOCATION_UPDATES': {'Landroid/telephony/TelephonyManager;': [('F'
                                 , 'disableLocationUpdates', '()'), ('F'
                                 , 'enableLocationUpdates', '()')],
                                 'Lcom/android/internal/telephony/ITelephony$Stub$Proxy;': [('F'
                                 , 'disableLocationUpdates', '()'), ('F'
                                 , 'enableLocationUpdates', '()')]},
    'CLEAR_APP_CACHE': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F'
                        , 'freeStorage', '(J LIntentSender;)'), ('F',
                        'freeStorageAndNotify',
                        '(J LIPackageDataObserver;)'), ('F',
                        'freeStorage',
                        '(J Landroid/content/IntentSender;)'), ('F',
                        'freeStorageAndNotify',
                        ...
                        'Landroid/content/pm/IPackageManager$Stub$Proxy;': [('F'
                        , 'freeStorage',
                        '(J Landroid/content/IntentSender;)'), ('F',
                        'freeStorageAndNotify',
                        '(J Landroid/content/pm/IPackageDataObserver;)'
                        )]},
    'BIND_INPUT_METHOD': {'Landroid/view/inputmethod/InputMethod;': [('C'
                          , 'SERVICE_INTERFACE', 'Ljava/lang/String;'
                          )]},
    'SIGNAL_PERSISTENT_PROCESSES': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                                    , 'signalPersistentProcesses', '(I)'
                                    )]},
    'BATTERY_STATS': {'Lcom/android/internal/app/IBatteryStats$Stub$Proxy;': [('F'
                      , 'getAwakeTimeBattery', '()'), ('F',
                      'getAwakeTimePlugged', '()'), ('F',
                      'getStatistics', '()')]},
    'AUTHENTICATE_ACCOUNTS': {'Landroid/accounts/AccountManager;': [
    ...
    'CHANGE_BACKGROUND_DATA_SETTING': {'Landroid/net/IConnectivityManager$Stub$Proxy;': [('F'
            , 'setBackgroundDataSetting', '(B)')],
            'Landroid/net/ConnectivityManager;': [('F',
            'setBackgroundDataSetting', '(B)')]},
    'RESTART_PACKAGES': {'Landroid/app/ActivityManagerNative;': [('F',
                         'killBackgroundProcesses',
                         '(Ljava/lang/String;)'), ('F', 'restartPackage'
                         , '(Ljava/lang/String;)')],
                         'Landroid/app/ActivityManager;': [('F',
                         'killBackgroundProcesses',
                         '(Ljava/lang/String;)'), ('F', 'restartPackage'
                         , '(Ljava/lang/String;)')]},
    'CALL_PRIVILEGED': {'Landroid/telephony/TelephonyManager;': [('F',
                        'getCompleteVoiceMailNumber', '()')],
                        'Landroid/telephony/PhoneNumberUtils;': [('F',
                        'getNumberFromIntent',
                        '(Landroid/content/Intent; Landroid/content/Context;)'
                        )]},
    'SET_WALLPAPER_COMPONENT': {'Landroid/app/IWallpaperManager$Stub$Proxy;': [('F'
                                , 'setWallpaperComponent',
                                '(Landroid/content/ComponentName;)')]},
    'DISABLE_KEYGUARD': {'Landroid/view/IWindowManager$Stub$Proxy;': [('F'
                         , 'disableKeyguard',
                         '(Landroid/os/IBinder; Ljava/lang/String;)'),
                         ('F', 'exitKeyguardSecurely',
                         '(Landroid/view/IOnKeyguardExitResult;)'), ('F'
                         , 'reenableKeyguard', '(Landroid/os/IBinder;)'
                         )], 'Landroid/app/KeyguardManager;': [('F',
                         'exitKeyguardSecurely',
                         '(Landroid/app/KeyguardManager$OnKeyguardExitResult;)'
                         )],
                         'Landroid/app/KeyguardManager$KeyguardLock;': [('F'
                         , 'disableKeyguard', '()'), ('F',
                         'reenableKeyguard', '()')]},
    'DELETE_PACKAGES': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F'
                        , 'deletePackage',
    ...
    'CHANGE_COMPONENT_ENABLED_STATE': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F'
            , 'setApplicationEnabledSetting', '(Ljava/lang/String; I I)'
            ), ('F', 'setComponentEnabledSetting',
            '(LComponentName; I I)'), ('F',
            'setApplicationEnabledSetting', '(Ljava/lang/String; I I)'
            ), ('F', 'setComponentEnabledSetting',
            ...
            '(Landroid/content/ComponentName; I I)')]},
    'ASEC_ACCESS': {'Landroid/os/storage/IMountService$Stub$Proxy;': [('F'
                    , 'getSecureContainerList', '()'), ('F',
                    'getSecureContainerPath', '(Ljava/lang/String;)'),
                    ('F', 'isSecureContainerMounted',
                    '(Ljava/lang/String;)')]},
    'UPDATE_DEVICE_STATS': {'Lcom/android/internal/app/IUsageStats$Stub$Proxy;': [('F'
                            , 'noteLaunchTime', '(LComponentName;)')]},
    'RECORD_AUDIO': {
        'Landroid/net/sip/SipAudioCall;': [('F', 'startAudio', '()')],
        'Landroid/media/MediaRecorder;': [('F', 'setAudioSource', '(I)'
                )],
        ...
        'Landroid/media/AudioRecord;': [('F', '<init>', '(I I I I I)'
                )],
        },
    'ACCESS_MOCK_LOCATION': {'Landroid/location/LocationManager;': [
        ('F', 'addTestProvider',
         '(Ljava/lang/String; B B B B B B B I I)'),
    ...
    'VIBRATE': {
        ...
        'Landroid/os/Vibrator;': [('F', 'cancel', '()'), ('F', 'vibrate'
                                  , '([L; I)'), ('F', 'vibrate', '(J)'
                                  )],
        'Landroid/provider/Settings/System;': [('C', 'VIBRATE_ON',
                'Ljava/lang/String;')],
        'Landroid/app/NotificationManager;': [('F', 'notify',
                '(I Landroid/app/Notification;)'), ('F', 'notify',
                '(Ljava/lang/String; I Landroid/app/Notification;)')],
        'Landroid/app/Notification/Builder;': [('F', 'setDefaults',
                '(I)')],
        'Landroid/os/IVibratorService$Stub$Proxy;': [('F',
                'cancelVibrate', '(Landroid/os/IBinder;)'), ('F',
                'vibrate', '(J Landroid/os/IBinder;)'), ('F',
                'vibratePattern', '([L; I Landroid/os/IBinder;)')],
        'Landroid/app/Notification;': [('C', 'DEFAULT_VIBRATE', 'I'),
                ('C', 'defaults', 'I')],
        },
    'ASEC_CREATE': {'Landroid/os/storage/IMountService$Stub$Proxy;': [('F'
                    , 'createSecureContainer',
                    '(Ljava/lang/String; I Ljava/lang/String; Ljava/lang/String; I)'
                    ), ('F', 'finalizeSecureContainer',
                    '(Ljava/lang/String;)')]},
    'WRITE_SECURE_SETTINGS': {
        'Landroid/bluetooth/BluetoothAdapter;': [('F', 'setScanMode',
                '(I I)'), ('F', 'setScanMode', '(I)')],
        'Landroid/server/BluetoothService;': [('F', 'setScanMode',
                '(I I)')],
        'Landroid/os/IPowerManager$Stub$Proxy;': [('F',
                'setMaximumScreenOffTimeount', '(I)')],
        'Landroid/content/pm/IPackageManager$Stub$Proxy;': [('F',
                'setInstallLocation', '(I)')],
        'Landroid/bluetooth/IBluetooth$Stub$Proxy;': [('F',
                'setScanMode', '(I I)')],
        },
    'SET_ORIENTATION': {'Landroid/view/IWindowManager$Stub$Proxy;': [('F'
                        , 'setRotation', '(I B I)')]},
    'PACKAGE_USAGE_STATS': {'Lcom/android/internal/app/IUsageStats$Stub$Proxy;': [('F'
                            , 'getAllPkgUsageStats', '()'), ('F',
                            'getPkgUsageStats', '(LComponentName;)')]},
    'FLASHLIGHT': {'Landroid/os/IHardwareService$Stub$Proxy;': [('F',
                   'setFlashlightEnabled', '(B)')]},
    'GLOBAL_SEARCH': {'Landroid/app/SearchManager;': [('C',
                      'EXTRA_SELECT_QUERY', 'Ljava/lang/String;'), ('C'
                      , 'INTENT_ACTION_GLOBAL_SEARCH',
                      'Ljava/lang/String;')],
                      'Landroid/server/search/Searchables;': [('F',
                      'buildSearchableList', '()'), ('F',
                      'findGlobalSearchActivity', '()')]},
    'CHANGE_WIFI_STATE': {'Landroid/net/wifi/IWifiManager$Stub$Proxy;': [
        ('F', 'addOrUpdateNetwork',
        ...
        ('F', 'setWifiApEnabled',
         '(Landroid/net/wifi/WifiConfiguration; B)'),
        ('F', 'setWifiEnabled', '(B)'),
        ('F', 'startScan', '(B)'),
    ...
    'BROADCAST_STICKY': {
        'Landroid/app/ExpandableListActivity;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
        ...
        'Landroid/accessibilityservice/AccessibilityService;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/accounts/GrantCredentialsPermissionActivity;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/app/backup/BackupAgent;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/service/wallpaper/WallpaperService;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/app/backup/BackupAgentHelper;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/accounts/AccountAuthenticatorActivity;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/app/IActivityManager$Stub$Proxy;': [('F',
                'unbroadcastIntent',
                '(Landroid/app/IApplicationThread; Landroid/content/Intent;)'
                )],
        'Landroid/app/ActivityGroup;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
                )],
        'Landroid/content/ContextWrapper;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
        ...
        'Landroid/app/Activity;': [('F', 'removeStickyBroadcast',
                                   '(Landroid/content/Intent;)'), ('F',
                                   'sendStickyBroadcast',
                                   '(Landroid/content/Intent;)'), ('F',
                                   'sendStickyOrderedBroadcast',
        ...
        'Landroid/app/ContextImpl;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
                )],
        'Landroid/app/AliasActivity;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
                )],
        'Landroid/content/Context;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
        ...
        'Landroid/service/urlrenderer/UrlRendererService;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/app/FullBackupAgent;': [('F', 'removeStickyBroadcast'
                , '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
                )],
        'Landroid/app/TabActivity;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
                )],
        'Landroid/view/ContextThemeWrapper;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/speech/RecognitionService;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/app/IntentService;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
                )],
        'Landroid/inputmethodservice/AbstractInputMethodService;': [('F'
                , 'removeStickyBroadcast', '(Landroid/content/Intent;)'
                ), ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
        ...
        'Landroid/app/Application;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
        ...
        'Landroid/app/ListActivity;': [('F', 'removeStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyOrderedBroadcast',
                '(Landroid/content/Intent; Landroid/content/BroadcastReceiver; Landroid/os/Handler; I Ljava/lang/String; Landroid/os/Bundle;)'
                )],
        'Landroid/app/Service;': [('F', 'removeStickyBroadcast',
                                  '(Landroid/content/Intent;)'), ('F',
                                  'sendStickyBroadcast',
                                  '(Landroid/content/Intent;)'), ('F',
                                  'sendStickyOrderedBroadcast',
        ...
        'Landroid/content/MutableContextWrapper;': [('F',
                'removeStickyBroadcast', '(Landroid/content/Intent;)'),
                ('F', 'sendStickyBroadcast',
                '(Landroid/content/Intent;)'), ('F',
                'sendStickyOrderedBroadcast',
    ...
    'FORCE_STOP_PACKAGES': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                            , 'forceStopPackage', '(Ljava/lang/String;)'
                            )],
                            'Landroid/app/ActivityManagerNative;': [('F'
                            , 'forceStopPackage', '(Ljava/lang/String;)'
                            )], 'Landroid/app/ActivityManager;': [('F',
                            'forceStopPackage', '(Ljava/lang/String;)'
                            )]},
    'KILL_BACKGROUND_PROCESSES': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                                  , 'killBackgroundProcesses',
                                  '(Ljava/lang/String;)')],
                                  'Landroid/app/ActivityManager;': [('F'
                                  , 'killBackgroundProcesses',
                                  '(Ljava/lang/String;)')]},
    'SET_TIME_ZONE': {'Landroid/app/AlarmManager;': [('F', 'setTimeZone'
                      , '(Ljava/lang/String;)'), ('F', 'setTimeZone',
                      '(Ljava/lang/String;)')],
                      'Landroid/app/IAlarmManager$Stub$Proxy;': [('F',
                      'setTimeZone', '(Ljava/lang/String;)')]},
    'BLUETOOTH_ADMIN': {
        ...
        'Landroid/bluetooth/BluetoothPbap;': [('F', 'disconnect', '()'
                )],
        'Landroid/bluetooth/IBluetoothA2dp$Stub$Proxy;': [('F',
                'connectSink', '(Landroid/bluetooth/BluetoothDevice;)'
                ), ('F', 'disconnectSink',
                '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'resumeSink', '(Landroid/bluetooth/BluetoothDevice;)'),
                ('F', 'setSinkPriority',
                '(Landroid/bluetooth/BluetoothDevice; I)'), ('F',
                'suspendSink', '(Landroid/bluetooth/BluetoothDevice;)'
                )],
        ...
        'Landroid/bluetooth/BluetoothHeadset;': [('F', 'connectHeadset'
                , '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'disconnectHeadset', '()'), ('F', 'setPriority',
                '(Landroid/bluetooth/BluetoothDevice; I)')],
        'Landroid/bluetooth/IBluetoothHeadset$Stub$Proxy;': [('F',
                'connectHeadset',
                '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'disconnectHeadset', '()'), ('F', 'setPriority',
                '(Landroid/bluetooth/BluetoothDevice; I)')],
        ...
        'Landroid/bluetooth/IBluetoothPbap$Stub$Proxy;': [('F',
                'connect', '(Landroid/bluetooth/BluetoothDevice;)'),
                ('F', 'disconnect', '()')],
        'Landroid/bluetooth/BluetoothA2dp;': [('F', 'connectSink',
                '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'disconnectSink',
                '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'resumeSink', '(Landroid/bluetooth/BluetoothDevice;)'),
    ...
    'INJECT_EVENTS': {'Landroid/view/IWindowManager$Stub$Proxy;': [('F'
                      , 'injectKeyEvent', '(Landroid/view/KeyEvent; B)'
                      ), ('F', 'injectPointerEvent',
                      '(Landroid/view/MotionEvent; B)'), ('F',
                      'injectTrackballEvent',
                      '(Landroid/view/MotionEvent; B)')],
    ...
    'CAMERA': {
        'Landroid/hardware/Camera/ErrorCallback;': [('F', 'onError',
                '(I Landroid/hardware/Camera;)')],
        'Landroid/media/MediaRecorder;': [('F', 'setVideoSource', '(I)'
                )],
        'Landroid/view/KeyEvent;': [('C', 'KEYCODE_CAMERA', 'I')],
        'Landroid/bluetooth/BluetoothClass/Device;': [('C',
                'AUDIO_VIDEO_VIDEO_CAMERA', 'I')],
        'Landroid/provider/MediaStore;': [('C',
                'INTENT_ACTION_STILL_IMAGE_CAMERA', 'Ljava/lang/String;'
                ), ('C', 'INTENT_ACTION_VIDEO_CAMERA',
                'Ljava/lang/String;')],
        'Landroid/hardware/Camera/CameraInfo;': [('C',
                'CAMERA_FACING_BACK', 'I'), ('C', 'CAMERA_FACING_FRONT'
                , 'I'), ('C', 'facing', 'I')],
        'Landroid/provider/ContactsContract/StatusColumns;': [('C',
                'CAPABILITY_HAS_CAMERA', 'I')],
        'Landroid/hardware/Camera/Parameters;': [('F', 'setRotation',
                '(I)')],
        'Landroid/media/MediaRecorder/VideoSource;': [('C', 'CAMERA',
                'I')],
        'Landroid/content/Intent;': [('C', 'IntentResolution',
                'Ljava/lang/String;'), ('C', 'ACTION_CAMERA_BUTTON',
                'Ljava/lang/String;')],
        'Landroid/content/pm/PackageManager;': [('C', 'FEATURE_CAMERA',
                'Ljava/lang/String;'), ('C', 'FEATURE_CAMERA_AUTOFOCUS'
                , 'Ljava/lang/String;'), ('C', 'FEATURE_CAMERA_FLASH',
                'Ljava/lang/String;'), ('C', 'FEATURE_CAMERA_FRONT',
                'Ljava/lang/String;')],
        'Landroid/hardware/Camera;': [('C', 'CAMERA_ERROR_SERVER_DIED',
                'I'), ('C', 'CAMERA_ERROR_UNKNOWN', 'I'), ('F',
                'setDisplayOrientation', '(I)'), ('F', 'native_setup',
                '(Ljava/lang/Object;)'), ('F', 'open', '()')],
        },
    'SET_WALLPAPER': {
        'Landroid/app/Activity;': [('F', 'clearWallpaper', '()'), ('F',
                                   'setWallpaper',
                                   '(Landroid/graphics/Bitmap;)'), ('F'
                                   , 'setWallpaper',
                                   '(Ljava/io/InputStream;)')],
        'Landroid/app/ExpandableListActivity;': [('F', 'clearWallpaper'
                , '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/accessibilityservice/AccessibilityService;': [('F',
                'clearWallpaper', '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/accounts/GrantCredentialsPermissionActivity;': [('F',
                'clearWallpaper', '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/app/backup/BackupAgent;': [('F', 'clearWallpaper',
                '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/service/wallpaper/WallpaperService;': [('F',
        ...
        'Landroid/accounts/AccountAuthenticatorActivity;': [('F',
                ...
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/app/IWallpaperManager$Stub$Proxy;': [('F',
                'setWallpaper', '(Ljava/lang/String;)')],
        'Landroid/app/ActivityGroup;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/content/ContextWrapper;': [('F', 'clearWallpaper',
                '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/app/WallpaperManager;': [('F', 'setBitmap',
                '(Landroid/graphics/Bitmap;)'), ('F', 'clear', '()'),
                ('F', 'setBitmap', '(Landroid/graphics/Bitmap;)'), ('F'
                , 'setResource', '(I)'), ('F', 'setStream',
                '(Ljava/io/InputStream;)')],
        'Landroid/app/ContextImpl;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/app/AliasActivity;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/content/Context;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/service/urlrenderer/UrlRendererService;': [('F',
                'clearWallpaper', '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/app/FullBackupAgent;': [('F', 'clearWallpaper', '()'
                ), ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'
                ), ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/app/TabActivity;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/view/ContextThemeWrapper;': [('F', 'clearWallpaper',
                '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/speech/RecognitionService;': [('F', 'clearWallpaper',
                '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/app/IntentService;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/inputmethodservice/AbstractInputMethodService;': [('F'
                , 'clearWallpaper', '()'), ('F', 'setWallpaper',
                '(Landroid/graphics/Bitmap;)'), ('F', 'setWallpaper',
                '(Ljava/io/InputStream;)')],
        'Landroid/app/Application;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/app/ListActivity;': [('F', 'clearWallpaper', '()'),
                ('F', 'setWallpaper', '(Landroid/graphics/Bitmap;)'),
                ('F', 'setWallpaper', '(Ljava/io/InputStream;)')],
        'Landroid/app/Service;': [('F', 'clearWallpaper', '()'), ('F',
                                  'setWallpaper',
                                  '(Landroid/graphics/Bitmap;)'), ('F',
                                  'setWallpaper',
                                  '(Ljava/io/InputStream;)')],
    ...
    'WAKE_LOCK': {
        'Landroid/net/wifi/IWifiManager$Stub$Proxy;': [('F',
                'acquireWifiLock',
                '(Landroid/os/IBinder; I Ljava/lang/String;)'), ('F',
                'releaseWifiLock', '(Landroid/os/IBinder;)')],
        'Landroid/bluetooth/HeadsetBase;': [('F', 'acquireWakeLock',
                '()'), ('F', 'finalize', '()'), ('F', 'handleInput',
                '(Ljava/lang/String;)'), ('F', 'releaseWakeLock', '()'
                )],
        'Landroid/os/PowerManager$WakeLock;': [('F', 'acquire', '()'),
                ('F', 'acquire', '(J)'), ('F', 'release', '()'), ('F',
                'release', '(I)')],
        'Landroid/media/MediaPlayer;': [('F', 'setWakeMode',
                '(Landroid/content/Context; I)'), ('F', 'start', '()'),
                ('F', 'stayAwake', '(B)'), ('F', 'stop', '()')],
        'Landroid/bluetooth/ScoSocket;': [('F', 'acquireWakeLock', '()'
                ), ('F', 'close', '()'), ('F', 'finalize', '()'), ('F',
                'releaseWakeLock', '()'), ('F', 'releaseWakeLockNow',
                '()')],
        'Landroid/media/AsyncPlayer;': [('F', 'acquireWakeLock', '()'),
                ('F', 'enqueueLocked',
                '(Landroid/media/AsyncPlayer$Command;)'), ('F', 'play',
                '(Landroid/content/Context; Landroid/net/Uri; B I)'),
                ('F', 'releaseWakeLock', '()'), ('F', 'stop', '()')],
        'Landroid/net/wifi/WifiManager$WifiLock;': [('F', 'acquire',
                '()'), ('F', 'finalize', '()'), ('F', 'release', '()'
                )],
        'Landroid/os/IPowerManager$Stub$Proxy;': [('F',
                'acquireWakeLock',
                '(I Landroid/os/IBinder; Ljava/lang/String;)'), ('F',
                'releaseWakeLock', '(Landroid/os/IBinder; I)')],
        'Landroid/net/sip/SipAudioCall;': [('F', 'startAudio', '()')],
    ...
    'MANAGE_ACCOUNTS': {'Landroid/accounts/AccountManager;': [
        ('F', 'addAccount',
    ...
    'WRITE_CALENDAR': {'Landroid/provider/Calendar$CalendarAlerts;': [('F'
                       , 'insert',
                       '(Landroid/content/ContentResolver; J J J J I)'
                       )],
                       'Landroid/provider/Calendar$Calendars;': [('F',
                       'delete',
    ...
    'BIND_APPWIDGET': {'Landroid/appwidget/AppWidgetManager;': [('F',
                       'bindAppWidgetId',
                       '(I Landroid/content/ComponentName;)')],
                       'Lcom/android/internal/appwidget/IAppWidgetService$Stub$Proxy;': [('F'
                       , 'bindAppWidgetId', '(I LComponentName;)')]},
    'ASEC_MOUNT_UNMOUNT': {'Landroid/os/storage/IMountService$Stub$Proxy;': [('F'
                           , 'mountSecureContainer',
                           '(Ljava/lang/String; Ljava/lang/String; I)'
                           ), ('F', 'unmountSecureContainer',
                           '(Ljava/lang/String; B)')]},
    'SET_PREFERRED_APPLICATIONS': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [
        ...
        ('F', 'replacePreferredActivity',
         '(Landroid/content/IntentFilter; I [Landroid/content/ComponentName; Landroid/content/ComponentName;)'
                ...
                '(Landroid/content/IntentFilter; I [Landroid/content/ComponentName; Landroid/content/ComponentName;)'
                ), ('F', 'clearPackagePreferredActivities',
                '(Ljava/lang/String;)'), ('F',
    ...
    'NFC': {
        'Landroid/inputmethodservice/InputMethodService;': [('C',
                'SoftInputView', 'I'), ('C', 'CandidatesView', 'I'),
                ('C', 'FullscreenMode', 'I'), ('C', 'GeneratingText',
                'I')],
        'Landroid/nfc/tech/NfcA;': [('F', 'close', '()'), ('F',
                                    'connect', '()'), ('F', 'get',
                                    '(Landroid/nfc/Tag;)'), ('F',
                                    'transceive', '([B)')],
        'Landroid/nfc/tech/NfcB;': [('F', 'close', '()'), ('F',
                                    'connect', '()'), ('F', 'get',
                                    '(Landroid/nfc/Tag;)'), ('F',
                                    'transceive', '([B)')],
        ...
        'Landroid/nfc/tech/NfcF;': [('F', 'close', '()'), ('F',
                                    'connect', '()'), ('F', 'get',
                                    '(Landroid/nfc/Tag;)'), ('F',
                                    'transceive', '([B)')],
        'Landroid/nfc/tech/NdefFormatable;': [('F', 'close', '()'), ('F'
                , 'connect', '()'), ('F', 'format',
                '(Landroid/nfc/NdefMessage;)'), ('F', 'formatReadOnly',
        ...
        'Landroid/nfc/Tag;': [('F', 'getTechList', '()')],
        ...
        'Landroid/nfc/NfcManager;': [('F', 'getDefaultAdapter', '()')],
        'Landroid/nfc/tech/MifareUltralight;': [('F', 'close', '()'),
                ('F', 'connect', '()'), ('F', 'readPages', '(I)'), ('F'
                , 'transceive', '([B)'), ('F', 'writePage', '(I [B)')],
        'Landroid/nfc/tech/NfcV;': [('F', 'close', '()'), ('F',
                                    'connect', '()'), ('F', 'get',
                                    '(Landroid/nfc/Tag;)'), ('F',
                                    'transceive', '([B)')],
        'Landroid/nfc/tech/TagTechnology;': [('F', 'close', '()'), ('F'
                , 'connect', '()')],
        'Landroid/preference/PreferenceActivity;': [('C', 'SampleCode',
                'Ljava/lang/String;')],
        'Landroid/content/pm/PackageManager;': [('C', 'FEATURE_NFC',
                'Ljava/lang/String;')],
        'Landroid/content/Context;': [('C', 'NFC_SERVICE',
                'Ljava/lang/String;')],
        ...
        'Landroid/nfc/tech/IsoDep;': [('F', 'close', '()'), ('F',
                'connect', '()'), ('F', 'setTimeout', '(I)'), ('F',
                'transceive', '([B)')],
        },
    'CALL_PHONE': {'Lcom/android/internal/telephony/ITelephony$Stub$Proxy;': [('F'
                   , 'call', '(Ljava/lang/String;)'), ('F', 'endCall',
                   '()')]},
    'INTERNET': {
        'Lcom/android/http/multipart/FilePart;': [('F', 'sendData',
                '(Ljava/io/OutputStream;)'), ('F',
                'sendDispositionHeader', '(Ljava/io/OutputStream;)')],
        'Ljava/net/HttpURLConnection;': [('F', '<init>',
                '(Ljava/net/URL;)'), ('F', 'connect', '()')],
        'Landroid/webkit/WebSettings;': [('F', 'setBlockNetworkLoads',
                '(B)'), ('F', 'verifyNetworkAccess', '()')],
        ...
        'Lcom/android/http/multipart/Part;': [('F', 'send',
                '(Ljava/io/OutputStream;)'), ('F', 'sendParts',
                '(Ljava/io/OutputStream; [Lcom/android/http/multipart/Part;)'
                ), ('F', 'sendParts',
                '(Ljava/io/OutputStream; [Lcom/android/http/multipart/Part; [B)'
                ), ('F', 'sendStart', '(Ljava/io/OutputStream;)'), ('F'
                , 'sendTransferEncodingHeader',
                '(Ljava/io/OutputStream;)')],
        'Landroid/drm/DrmErrorEvent;': [('C',
                'TYPE_NO_INTERNET_CONNECTION', 'I')],
        'Landroid/webkit/WebViewCore;': [('F', '<init>',
                '(Landroid/content/Context; Landroid/webkit/WebView; Landroid/webkit/CallbackProxy; Ljava/util/Map;)'
                )],
        'Ljava/net/URLConnection;': [('F', 'connect', '()'), ('F',
                'getInputStream', '()')],
        'Landroid/app/Activity;': [('F', 'setContentView', '(I)')],
        'Ljava/net/MulticastSocket;': [('F', '<init>', '()'), ('F',
                '<init>', '(I)'), ('F', '<init>',
                '(Ljava/net/SocketAddress;)')],
        'Lcom/android/http/multipart/StringPart;': [('F', 'sendData',
                '(Ljava/io/OuputStream;)')],
        'Ljava/net/URL;': [('F', 'getContent', '([Ljava/lang/Class;)'),
                           ('F', 'getContent', '()'), ('F',
                           'openConnection', '(Ljava/net/Proxy;)'), ('F'
                           , 'openConnection', '()'), ('F', 'openStream'
                           , '()')],
        'Ljava/net/DatagramSocket;': [('F', '<init>', '()'), ('F',
                '<init>', '(I)'), ('F', '<init>',
                '(I Ljava/net/InetAddress;)'), ('F', '<init>',
                '(Ljava/net/SocketAddress;)')],
        ...
        'Ljava/net/Socket;': [
            ...
            ('F', '<init>',
             '(Ljava/lang/String; I Ljava/net/InetAddress; I)'),
        ...
        'Landroid/webkit/WebView;': [('F', '<init>',
        ...
        'Ljava/net/NetworkInterface;': [('F', '<init>', '()'), ('F',
                '<init>',
                '(Ljava/lang/String; I Ljava/net/InetAddress;)')],
        },
    'ACCESS_FINE_LOCATION': {
        'Landroid/webkit/WebChromeClient;': [('F',
        ...
        'Landroid/location/LocationManager;': [
            ...
            ('F', 'addNmeaListener',
             '(Landroid/location/GpsStatus$NmeaListener;)'),
            ('F', 'addProximityAlert',
             '(D D F J Landroid/app/PendingIntent;)'),
        ...
        'Landroid/webkit/GeolocationService;': [('F',
                'registerForLocationUpdates', '()'), ('F',
                'setEnableGps', '(B)'), ('F', 'start', '()')],
        'Landroid/telephony/TelephonyManager;': [('F', 'getCellLocation'
                , '()'), ('F', 'getCellLocation', '()'), ('F',
        ...
        'Lcom/android/internal/telephony/ITelephony$Stub$Proxy;': [('F'
                , 'getCellLocation', '()'), ('F',
                'getNeighboringCellInfo', '()')],
        'Landroid/webkit/GeolocationPermissions$Callback;': [('F',
                'invok', '()')],
        },
    'READ_SMS': {
        'Landroid/provider/Telephony$Sms$Inbox;': [('F', 'addMessage',
                '(Landroid/content/ContentResolver; Ljava/lang/String; Ljava/lang/String; Ljava/lang/String; Ljava/lang/Long; B)'
                )],
        'Landroid/provider/Telephony$Threads;': [('F',
                'getOrCreateThreadId',
                '(Landroid/content/Context; Ljava/lang/String;)'), ('F'
                , 'getOrCreateThreadId',
                '(Landroid/content/Context; Ljava/util/Set;)')],
        'Landroid/provider/Telephony$Mms;': [('F', 'query',
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin; Ljava/lang/String; Ljava/lang/String;)'
                ), ('F', 'query',
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin;)'
                )],
        'Landroid/provider/Telephony$Sms$Draft;': [('F', 'addMessage',
                '(Landroid/content/ContentResolver; Ljava/lang/String; Ljava/lang/String; Ljava/lang/String; Ljava/lang/Long;)'
                )],
        'Landroid/provider/Telephony$Sms$Sent;': [('F', 'addMessage',
                '(Landroid/content/ContentResolver; Ljava/lang/String; Ljava/lang/String; Ljava/lang/String; Ljava/lang/Long;)'
                )],
        'Landroid/provider/Telephony$Sms;': [('F', 'query',
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin; Ljava/lang/String; Ljava/lang/String;)'
                ), ('F', 'query',
                '(Landroid/content/ContentResolver; [L[Ljava/lang/Strin;)'
                )],
        },
    'ACCESS_SURFACE_FLINGER': {'Landroid/view/SurfaceSession;': [('F',
                               '<init>', '()')],
                               'Landroid/view/Surface;': [('F',
                               'closeTransaction', '()'), ('F',
                               'freezeDisplay', '(I)'), ('F',
                               'setOrientation', '(I I I)'), ('F',
                               'setOrientation', '(I I)'), ('F',
                               'unfreezeDisplay', '(I)')]},
    'REORDER_TASKS': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                      , 'moveTaskBackwards', '(I)'), ('F',
                      'moveTaskToBack', '(I)'), ('F', 'moveTaskToFront'
                      , '(I)')], 'Landroid/app/ActivityManager;': [('F'
                      , 'moveTaskToFront', '(I I)')]},
    'MODIFY_AUDIO_SETTINGS': {
        'Landroid/net/sip/SipAudioCall;': [('F', 'setSpeakerMode', '(B)'
                )],
        'Landroid/server/BluetoothA2dpService;': [('F',
                'checkSinkSuspendState', '(I)'), ('F',
                'handleSinkStateChange',
                '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'onBluetoothDisable', '()'), ('F', 'onBluetoothEnable',
                '()')],
        'Landroid/media/IAudioService$Stub$Proxy;': [('F',
                'setBluetoothScoOn', '(B)'), ('F', 'setMode',
                '(I Landroid/os/IBinder;)'), ('F', 'setSpeakerphoneOn',
                '(B)'), ('F', 'startBluetoothSco',
                '(Landroid/os/IBinder;)'), ('F', 'stopBluetoothSco',
                '(Landroid/os/IBinder;)')],
        'Landroid/media/AudioService;': [('F', 'setBluetoothScoOn',
                '(B)'), ('F', 'setMode', '(I Landroid/os/IBinder;)'),
                ('F', 'setSpeakerphoneOn', '(B)'), ('F',
                'startBluetoothSco', '(Landroid/os/IBinder;)'), ('F',
                'stopBluetoothSco', '(Landroid/os/IBinder;)')],
        'Landroid/media/AudioManager;': [
            ('F', 'startBluetoothSco', '()'),
            ('F', 'stopBluetoothSco', '()'),
            ('F', 'isBluetoothA2dpOn', '()'),
    ...
    'READ_PHONE_STATE': {
        ...
        'Landroid/telephony/PhoneStateListener;': [('C',
                'LISTEN_CALL_FORWARDING_INDICATOR', 'I'), ('C',
                'LISTEN_CALL_STATE', 'I'), ('C', 'LISTEN_DATA_ACTIVITY'
                , 'I'), ('C', 'LISTEN_MESSAGE_WAITING_INDICATOR', 'I'),
                ('C', 'LISTEN_SIGNAL_STRENGTH', 'I')],
        'Landroid/accounts/AccountManagerService$SimWatcher;': [('F',
                'onReceive',
                '(Landroid/content/Context; Landroid/content/Intent;)'
                )],
        'Lcom/android/internal/telephony/CallerInfo;': [('F',
                'markAsVoiceMail', '()')],
        'Landroid/os/Build/VERSION_CODES;': [('C', 'DONUT', 'I')],
        ...
        'Lcom/android/internal/telephony/ITelephonyRegistry$Stub$Proxy;': [('F'
                , 'listen',
                '(Ljava/lang/String; Lcom/android/internal/telephony/IPhoneStateListener; I B)'
                )],
        'Landroid/telephony/PhoneNumberUtils;': [('F',
                'isVoiceMailNumber', '(Ljava/lang/String;)')],
        'Lcom/android/internal/telephony/ITelephony$Stub$Proxy;': [('F'
                , 'isSimPinEnabled', '()')],
        },
    'WRITE_SETTINGS': {
        'Landroid/media/RingtoneManager;': [('F',
                'setActualDefaultRingtoneUri',
                '(Landroid/content/Context; I Landroid/net/Uri;)')],
        'Landroid/os/IPowerManager$Stub$Proxy;': [('F',
                'setStayOnSetting', '(I)')],
        'Landroid/server/BluetoothService;': [('F',
                'persistBluetoothOnSetting', '(B)')],
        'Landroid/provider/Settings$Secure;': [('F', 'putFloat',
        ...
        'Landroid/provider/Settings$Bookmarks;': [('F', 'add',
        ...
        'Landroid/os/IMountService$Stub$Proxy;': [('F', 'setAutoStartUm'
    ...
    'BIND_WALLPAPER': {'Landroid/service/wallpaper/WallpaperService;': [('C'
                       , 'SERVICE_INTERFACE', 'Ljava/lang/String;')],
                       'Lcom/android/server/WallpaperManagerService;': [('F'
                       , 'bindWallpaperComponentLocked',
                       '(Landroid/content/ComponentName;)')]},
    'DUMP': {
        'Landroid/content/ContentService;': [('F', 'dump',
                '(Ljava/io/FileDescriptor; Ljava/io/PrintWriter; [L[Ljava/lang/Strin;)'
                )],
        'Landroid/view/IWindowManager$Stub$Proxy;': [('F',
                'isViewServerRunning', '()'), ('F', 'startViewServer',
                '(I)'), ('F', 'stopViewServer', '()')],
        'Landroid/os/Debug;': [('F', 'dumpService',
                               '(Ljava/lang/String; Ljava/io/FileDescriptor; [Ljava/lang/String;)'
                               )],
        'Landroid/os/IBinder;': [('C', 'DUMP_TRANSACTION', 'I')],
        'Lcom/android/server/WallpaperManagerService;': [('F', 'dump',
                '(Ljava/io/FileDescriptor; Ljava/io/PrintWriter; [L[Ljava/lang/Stri;)'
                )],
        },
    'USE_CREDENTIALS': {'Landroid/accounts/AccountManager;': [
        ...
        ], 'Landroid/accounts/AccountManagerService;': [('F',
                'getAuthToken',
                '(Landroid/accounts/IAccountManagerResponse; Landroid/accounts/Account; Ljava/lang/String; B B Landroid/os/Bundle;)'
                )],
            'Landroid/accounts/IAccountManager$Stub$Proxy;': [('F',
                'getAuthToken',
                '(Landroid/accounts/IAccountManagerResponse; Landroid/accounts/Account; Ljava/lang/String; B B Landroid/os/Bundle;)'
                )]},
    'UPDATE_DEVICE_STATS': {'Lcom/android/internal/app/IUsageStats$Stub$Proxy;': [('F'
                            , 'notePauseComponent', '(LComponentName;)'
                            ), ('F', 'noteResumeComponent',
                            '(LComponentName;)')],
    ...
    'SEND_SMS': {'Landroid/telephony/gsm/SmsManager;': [
        ('F', 'getDefault', '()'),
        ('F', 'sendDataMessage',
        ...
        ], 'Lcom/android/internal/telephony/ISms$Stub$Proxy;': [('F',
                'sendData',
    ...
    'WRITE_USER_DICTIONARY': {'Landroid/provider/UserDictionary$Words;': [('F'
                              , 'addWord',
                              '(Landroid/content/Context; Ljava/lang/String; I I)'
                              )]},
    'ACCESS_COARSE_LOCATION': {'Landroid/telephony/TelephonyManager;': [('F'
                               , 'getCellLocation', '()')],
                               'Landroid/telephony/PhoneStateListener;': [('C'
                               , 'LISTEN_CELL_LOCATION', 'I')],
                               'Landroid/location/LocationManager;': [('C'
                               , 'NETWORK_PROVIDER',
                               'Ljava/lang/String;')]},
    'ASEC_RENAME': {'Landroid/os/storage/IMountService$Stub$Proxy;': [('F'
                    , 'renameSecureContainer',
                    '(Ljava/lang/String; Ljava/lang/String;)')]},
    'SYSTEM_ALERT_WINDOW': {'Landroid/view/IWindowSession$Stub$Proxy;': [('F'
                            , 'add',
                            '(Landroid/view/IWindow; Landroid/view/WindowManager$LayoutParams; I Landroid/graphics/Rect;)'
                            )]},
    'CHANGE_WIFI_MULTICAST_STATE': {'Landroid/net/wifi/IWifiManager$Stub$Proxy;': [('F'
                                    ...
                                    '()')],
                                    'Landroid/net/wifi/WifiManager$MulticastLock;': [('F'
                                    , 'acquire', '()'), ('F', 'finalize'
                                    , '()'), ('F', 'release', '()')],
                                    'Landroid/net/wifi/WifiManager;': [('F'
                                    , 'initializeMulticastFiltering',
                                    '()')]},
    'RECEIVE_BOOT_COMPLETED': {'Landroid/content/Intent;': [('C',
                               'ACTION_BOOT_COMPLETED',
                               'Ljava/lang/String;')]},
    'SET_ALARM': {'Landroid/provider/AlarmClock;': [('C',
                  'ACTION_SET_ALARM', 'Ljava/lang/String;'), ('C',
                  'EXTRA_HOUR', 'Ljava/lang/String;'), ('C',
                  'EXTRA_MESSAGE', 'Ljava/lang/String;'), ('C',
                  'EXTRA_MINUTES', 'Ljava/lang/String;'), ('C',
                  'EXTRA_SKIP_UI', 'Ljava/lang/String;')]},
    'WRITE_CONTACTS': {
        'Lcom/android/internal/telephony/IccPhoneBookInterfaceManager$Stub$Proxy;': [('F'
        ...
        'Landroid/provider/Contacts$People;': [('F', 'addToGroup',
                '(Landroid/content/ContentResolver; J J)')],
        'Landroid/provider/ContactsContract$Contacts;': [('F',
                'markAsContacted',
                '(Landroid/content/ContentResolver; J)')],
        'Landroid/provider/Contacts$Settings;': [('F', 'setSetting',
                '(Landroid/content/ContentResolver; Ljava/lang/String; Ljava/lang/String; Ljava/lang/String;)'
                )],
        'Lcom/android/internal/telephony/IIccPhoneBook$Stub$Proxy;': [('F'
                , 'updateAdnRecordsInEfByIndex',
                '(I Ljava/lang/String; Ljava/lang/String; Ljava/lang/String;)'
                ), ('F', 'updateAdnRecordsInEfBySearch',
                '(I Ljava/lang/String; Ljava/lang/String; Ljava/lang/String; Ljava/lang/String; Ljava/lang/String;)'
                )],
        'Landroid/provider/CallLog$Calls;': [('F',
                'removeExpiredEntries', '(Landroid/content/Context;)'
                )],
        'Landroid/pim/vcard/VCardEntryCommitter;': [('F',
                'onEntryCreated', '(Landroid/pim/vcard/VCardEntry;)')],
        'Landroid/pim/vcard/VCardEntryHandler;': [('F', 'onEntryCreated'
                , '(Landroid/pim/vcard/VCardEntry;)')],
        'Landroid/pim/vcard/VCardEntry;': [('F',
                'pushIntoContentResolver',
                '(Landroid/content/ContentResolver;)')],
        },
    'PROCESS_OUTGOING_CALLS': {'Landroid/content/Intent;': [('C',
                               'ACTION_NEW_OUTGOING_CALL',
                               'Ljava/lang/String;')]},
    'EXPAND_STATUS_BAR': {'Landroid/app/StatusBarManager;': [('F',
                          'collapse', '()'), ('F', 'expand', '()'), ('F'
                          , 'toggle', '()')],
                          'Landroid/app/IStatusBar$Stub$Proxy;': [('F',
                          'activate', '()'), ('F', 'deactivate', '()'),
                          ('F', 'toggle', '()')]},
    'MODIFY_PHONE_STATE': {'Lcom/android/internal/telephony/ITelephony$Stub$Proxy;': [
        ('F', 'answerRingingCall', '()'),
        ...
        ('F', 'toggleRadioOnOff', '()'),
        ], 'Landroid/net/MobileDataStateTracker;': [('F', 'reconnect',
                '()'), ('F', 'setRadio', '(B)'), ('F', 'teardown', '()'
                )],
        ...
        ('F', 'notifySignalStrength',
         '(Landroid/telephony/SignalStrength;)'),
        ]},
    'MOUNT_FORMAT_FILESYSTEMS': {'Landroid/os/IMountService$Stub$Proxy;': [('F'
                                 , 'formatMedi', '()')],
                                 'Landroid/os/storage/IMountService$Stub$Proxy;': [('F'
                                 , 'formatVolume',
                                 '(Ljava/lang/String;)')]},
    'ACCESS_DOWNLOAD_MANAGER': {'Landroid/net/Downloads$DownloadBase;': [('F'
                                , 'startDownloadByUri',
                                ...
                                'Landroid/net/Downloads$ByUri;': [('F',
                                'getCurrentOtaDownloads',
                                '(Landroid/content/Context; Ljava/lang/String;)'
                                ), ('F', 'getProgressCursor',
                                '(Landroid/content/Context; J)'), ('F',
                                'getStatus',
    ...
    'READ_INPUT_STATE': {'Landroid/view/IWindowManager$Stub$Proxy;': [
    ...
    'READ_SYNC_STATS': {
        'Landroid/app/ContextImpl$ApplicationContentResolver;': [('F',
                'getCurrentSync', '()'), ('F', 'getSyncStatus',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'isSyncActive',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'isSyncPending',
                '(Landroid/accounts/Account; Ljava/lang/String;)')],
        'Landroid/content/ContentService;': [('F', 'getCurrentSync',
                '()'), ('F', 'getSyncStatus',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'isSyncActive',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'isSyncPending',
                '(Landroid/accounts/Account; Ljava/lang/String;)')],
        'Landroid/content/ContentResolver;': [('F', 'getCurrentSync',
                '()'), ('F', 'getSyncStatus',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
                , 'isSyncActive',
                '(Landroid/accounts/Account; Ljava/lang/String;)'), ('F'
    ...
    'SET_TIME': {'Landroid/app/AlarmManager;': [('F', 'setTime', '(J)'
                 ), ('F', 'setTimeZone', '(Ljava/lang/String;)'), ('F',
                 'setTime', '(J)')],
                 'Landroid/app/IAlarmManager$Stub$Proxy;': [('F',
                 'setTime', '(J)')]},
    'CHANGE_WIMAX_STATE': {'Lcom/htc/net/wimax/WimaxController$Stub$Proxy;': [('F'
                           , 'setWimaxEnable', '()')]},
    'MOUNT_UNMOUNT_FILESYSTEMS': {'Landroid/os/IMountService$Stub$Proxy;': [('F'
                                  , 'mountMedi', '()'), ('F',
                                  'unmountMedi', '()')],
                                  'Landroid/os/storage/IMountService$Stub$Proxy;': [('F'
                                  , 'getStorageUsers',
                                  '(Ljava/lang/String;)'), ('F',
                                  'mountVolume', '(Ljava/lang/String;)'
                                  ), ('F', 'setUsbMassStorageEnabled',
                                  '(B)'), ('F', 'unmountVolume',
                                  '(Ljava/lang/String; B)')],
                                  'Landroid/os/storage/StorageManager;': [('F'
                                  , 'disableUsbMassStorage', '()'), ('F'
                                  , 'enableUsbMassStorage', '()')]},
    'MOVE_PACKAGE': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F'
                     , 'movePackage',
                     '(Ljava/lang/String; LIPackageMoveObserver; I)'),
                     ('F', 'movePackage',
                     '(Ljava/lang/String; LIPackageMoveObserver; I)')],
                     'Landroid/content/pm/PackageManager;': [('F',
                     'movePackage',
    ...
    'ACCESS_WIMAX_STATE': {'Lcom/htc/net/wimax/WimaxController$Stub$Proxy;': [('F'
                           , 'getConnectionInf', '()'), ('F',
                           'getWimaxStat', '()'), ('F', 'isBackoffStat'
                           , '()'), ('F', 'isWimaxEnable', '()')]},
    'ACCESS_WIFI_STATE': {'Landroid/net/sip/SipAudioCall;': [('F',
                          'startAudio', '()')],
    ...
    'READ_HISTORY_BOOKMARKS': {'Landroid/webkit/WebIconDatabase;': [('F'
    ...
    'ASEC_DESTROY': {'Landroid/os/storage/IMountService$Stub$Proxy;': [('F'
    ...
    'ACCESS_NETWORK_STATE': {
        ...
        'Landroid/net/NetworkInfo;': [('F', 'isConnectedOrConnecting',
                '()')],
        ...
        'Landroid/net/http/RequestQueue;': [('F',
                'enablePlatformNotifications', '()'), ('F',
                'setProxyConfig', '()')],
        },
    'GET_TASKS': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F',
                  'getRecentTasks', '(I I)'), ('F', 'getTasks',
                  '(I I Landroid/app/IThumbnailReceiver;)')],
                  'Landroid/app/ActivityManagerNative;': [('F',
                  'getRecentTasks', '(I I)'), ('F', 'getRunningTasks',
                  '(I)')], 'Landroid/app/ActivityManager;': [('F',
                  'getRecentTasks', '(I I)'), ('F', 'getRunningTasks',
                  '(I)'), ('F', 'getRecentTasks', '(I I)'), ('F',
                  'getRunningTasks', '(I)')]},
    'STATUS_BAR': {
        'Landroid/view/View/OnSystemUiVisibilityChangeListener;': [('F'
                , 'onSystemUiVisibilityChange', '(I)')],
        'Landroid/view/View;': [('C', 'STATUS_BAR_HIDDEN', 'I'), ('C',
                                'STATUS_BAR_VISIBLE', 'I')],
        'Landroid/app/StatusBarManager;': [('F', 'addIcon',
                '(Ljava/lang/String; I I)'), ('F', 'disable', '(I)'),
                ('F', 'removeIcon', '(Landroid/os/IBinder;)'), ('F',
                'updateIcon',
                '(Landroid/os/IBinder; Ljava/lang/String; I I)')],
        'Landroid/view/WindowManager/LayoutParams;': [('C',
                'TYPE_STATUS_BAR', 'I'), ('C', 'TYPE_STATUS_BAR_PANEL',
                'I'), ('C', 'systemUiVisibility', 'I'), ('C', 'type',
                'I')],
        'Landroid/app/IStatusBar$Stub$Proxy;': [('F', 'addIcon',
                '(Ljava/lang/String; Ljava/lang/String; I I)'), ('F',
                'disable', '(I Landroid/os/IBinder; Ljava/lang/String;)'
                ), ('F', 'removeIcon', '(Landroid/os/IBinder;)'), ('F',
                'updateIcon',
    ...
    'SHUTDOWN': {
        'Landroid/app/IActivityManager$Stub$Proxy;': [('F', 'shutdown',
                '(I)')],
        'Landroid/os/IMountService$Stub$Proxy;': [('F', 'shutdow', '()'
                )],
        'Landroid/os/storage/IMountService$Stub$Proxy;': [('F',
                'shutdown',
                '(Landroid/os/storage/IMountShutdownObserver;)')],
        'Landroid/os/INetworkManagementService$Stub$Proxy;': [('F',
                'shutdown', '()')],
        },
    'READ_LOGS': {'Landroid/os/DropBoxManager;': [('C',
                  'ACTION_DROPBOX_ENTRY_ADDED', 'Ljava/lang/String;'),
                  ('F', 'getNextEntry', '(Ljava/lang/String; J)'), ('F'
                  , 'getNextEntry', '(Ljava/lang/String; J)')],
                  'Lcom/android/internal/os/IDropBoxManagerService$Stub$Proxy;': [('F'
                  , 'getNextEntry', '(Ljava/lang/String; J)')],
                  'Ljava/lang/Runtime;': [
    ...
    'BLUETOOTH': {
        'Landroid/os/Process;': [('C', 'BLUETOOTH_GID', 'I')],
        ...
        'Landroid/media/AudioManager;': [('C', 'ROUTE_BLUETOOTH', 'I'),
                ('C', 'ROUTE_BLUETOOTH_A2DP', 'I'), ('C',
                'ROUTE_BLUETOOTH_SCO', 'I')],
        'Landroid/bluetooth/IBluetoothA2dp$Stub$Proxy;': [('F',
                'getConnectedSinks', '()'), ('F',
                'getNonDisconnectedSinks', '()'), ('F',
                'getSinkPriority',
                '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'getSinkState', '(Landroid/bluetooth/BluetoothDevice;)'
                )],
        'Landroid/bluetooth/BluetoothSocket;': [('F', 'connect', '()'
                )],
        'Landroid/bluetooth/BluetoothPbap;': [('F', 'getClient', '()'),
        ...
        'Landroid/provider/Settings;': [('C',
                'ACTION_BLUETOOTH_SETTINGS', 'Ljava/lang/String;')],
        'Landroid/bluetooth/IBluetooth$Stub$Proxy;': [
        ...
        'Landroid/bluetooth/BluetoothProfile;': [('F',
                'getConnectedDevices', '()'), ('F', 'getConnectionState'
                , '(Landroid/bluetooth/BluetoothDevice;)'), ('F',
                'getDevicesMatchingConnectionStates', '([I)')],
        ...
        'Landroid/provider/Settings/Secure;': [('C', 'BLUETOOTH_ON',
                'Ljava/lang/String;')],
        'Landroid/bluetooth/IBluetoothPbap$Stub$Proxy;': [('F',
                'getClient', '()'), ('F', 'getState', '()'), ('F',
                'isConnected', '(Landroid/bluetooth/BluetoothDevice;)'
                )],
        'Landroid/server/BluetoothService;': [
            ...
            ('F', 'setPropertyString',
             '(Ljava/lang/String; Ljava/lang/String;)'),
            ('F', 'updateDeviceServiceChannelCache',
             '(Ljava/lang/String;)'),
            ('F', 'updateRemoteDevicePropertiesCache',
             '(Ljava/lang/String;)'),
            ],
        'Landroid/content/pm/PackageManager;': [('C',
                'FEATURE_BLUETOOTH', 'Ljava/lang/String;')],
        'Landroid/bluetooth/BluetoothAssignedNumbers;': [('C',
                'BLUETOOTH_SIG', 'I')],
        },
    'CLEAR_APP_USER_DATA': {
        'Landroid/app/ActivityManagerNative;': [('F',
        ...
        'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F',
                'clearApplicationUserData',
                '(Ljava/lang/String; LIPackageDataObserver;)'), ('F',
                'clearApplicationUserData',
    ...
    'WRITE_SMS': {'Landroid/provider/Telephony$Sms;': [('F',
                  'addMessageToUri',
                  ...
                  )], 'Landroid/provider/Telephony$Sms$Outbox;': [('F',
                  'addMessage',
                  '(Landroid/content/ContentResolver; Ljava/lang/String; Ljava/lang/String; Ljava/lang/String; Ljava/lang/Long; B J)'
                  )], 'Landroid/provider/Telephony$Sms$Draft;': [('F',
                  'saveMessage',
                  '(Landroid/content/ContentResolver; Landroid/net/Uri; Ljava/lang/String;)'
                  )]},
    'SET_PROCESS_LIMIT': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                          , 'setProcessForeground',
                          '(Landroid/os/IBinder; I B)'), ('F',
                          'setProcessLimit', '(I)')]},
    'DEVICE_POWER': {'Landroid/os/PowerManager;': [('F', 'goToSleep',
                     '(J)'), ('F', 'setBacklightBrightness', '(I)')],
    ...
    'PERSISTENT_ACTIVITY': {
        'Landroid/app/ExpandableListActivity;': [('F', 'setPersistent',
                '(B)')],
        'Landroid/accounts/GrantCredentialsPermissionActivity;': [('F',
                'setPersistent', '(B)')],
        'Landroid/app/Activity;': [('F', 'setPersistent', '(B)')],
        'Landroid/app/ListActivity;': [('F', 'setPersistent', '(B)')],
        'Landroid/app/AliasActivity;': [('F', 'setPersistent', '(B)')],
        'Landroid/accounts/AccountAuthenticatorActivity;': [('F',
                'setPersistent', '(B)')],
        'Landroid/app/IActivityManager$Stub$Proxy;': [('F',
                'setPersistent', '(Landroid/os/IBinder; B)')],
        'Landroid/app/TabActivity;': [('F', 'setPersistent', '(B)')],
        'Landroid/app/ActivityGroup;': [('F', 'setPersistent', '(B)')],
        },
    'MANAGE_APP_TOKENS': {'Landroid/view/IWindowManager$Stub$Proxy;': [
        ('F', 'addAppToken',
         '(I Landroid/view/IApplicationToken; I I B)'),
        ...
        ('F', 'setAppOrientation',
         '(Landroid/view/IApplicationToken; I)'),
    ...
    'WRITE_HISTORY_BOOKMARKS': {'Landroid/provider/Browser;': [
        ('C', 'BOOKMARKS_URI', 'Landroid/net/Uri;'),
        ('C', 'SEARCHES_URI', 'Landroid/net/Uri;'),
        ('F', 'addSearchUrl',
         '(Landroid/content/ContentResolver; Ljava/lang/String;)'),
    ...
    'FORCE_BACK': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F',
                   'unhandledBack', '(I)')]},
    'CHANGE_NETWORK_STATE': {'Landroid/net/IConnectivityManager$Stub$Proxy;': [
    ...
    'WRITE_SYNC_SETTINGS': {
        'Landroid/app/ContextImpl$ApplicationContentResolver;': [('F',
                ...
                ('F', 'setMasterSyncAutomatically', '(B)'), ('F',
                'setSyncAutomatically',
                '(Landroid/accounts/Account; Ljava/lang/String; B)')],
        'Landroid/content/ContentService;': [('F', 'addPeriodicSync',
                '(Landroid/accounts/Account; Ljava/lang/String; Landroid/os/Bundle; J)'
                ), ('F', 'removePeriodicSync',
                '(Landroid/accounts/Account; Ljava/lang/String; Landroid/os/Bundle;)'
                ), ('F', 'setIsSyncable',
                ...
                'setSyncAutomatically',
                '(Landroid/accounts/Account; Ljava/lang/String; B)')],
        'Landroid/content/ContentResolver;': [('F', 'addPeriodicSync',
                '(Landroid/accounts/Account; Ljava/lang/String; Landroid/os/Bundle; J)'
                ), ('F', 'removePeriodicSync',
                '(Landroid/accounts/Account; Ljava/lang/String; Landroid/os/Bundle;)'
                ), ('F', 'setIsSyncable',
    ...
    'ACCOUNT_MANAGER': {
        'Landroid/accounts/AccountManager;': [('C',
                'KEY_ACCOUNT_MANAGER_RESPONSE', 'Ljava/lang/String;')],
    ...
    'SET_ANIMATION_SCALE': {'Landroid/view/IWindowManager$Stub$Proxy;': [('F'
                            , 'setAnimationScale', '(I F)'), ('F',
                            'setAnimationScales', '([L;)')]},
    'GET_ACCOUNTS': {
        ...
        'Landroid/content/ContentService;': [('F', '<init>',
                '(Landroid/content/Context; B)'), ('F', 'main',
                '(Landroid/content/Context; B)')],
        'Landroid/accounts/AccountManager$GetAuthTokenByTypeAndFeaturesTask;': [('F'
                , 'doWork', '()'), ('F', 'start', '()')],
        'Landroid/accounts/AccountManager$AmsTask;': [('F', 'doWork',
                '()'), ('F', 'start', '()')],
        'Landroid/accounts/IAccountManager$Stub$Proxy;': [('F',
                'getAccounts', '(Ljava/lang/String;)'), ('F',
    ...
    'RECEIVE_SMS': {'Landroid/telephony/gsm/SmsManager;': [('F',
                    'copyMessageToSim', '([L; [L; I)'), ('F',
                    'deleteMessageFromSim', '(I)'), ('F',
                    'getAllMessagesFromSim', '()'), ('F',
                    'updateMessageOnSim', '(I I [L;)')],
                    'Landroid/telephony/SmsManager;': [('F',
                    'copyMessageToIcc', '([L; [L; I)'), ('F',
                    'deleteMessageFromIcc', '(I)'), ('F',
                    'getAllMessagesFromIcc', '()'), ('F',
                    'updateMessageOnIcc', '(I I [L;)')],
                    'Lcom/android/internal/telephony/ISms$Stub$Proxy;': [('F'
                    , 'copyMessageToIccEf', '(I [B [B)'), ('F',
                    'getAllMessagesFromIccEf', '()'), ('F',
                    'updateMessageOnIccEf', '(I I [B)')]},
    'STOP_APP_SWITCHES': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                          , 'resumeAppSwitches', '()'), ('F',
                          'stopAppSwitches', '()')]},
    'DELETE_CACHE_FILES': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F'
    ...
    'WRITE_EXTERNAL_STORAGE': {'Landroid/os/Build/VERSION_CODES;': [('C'
                               , 'DONUT', 'I')],
                               'Landroid/app/DownloadManager/Request;': [('F'
                               , 'setDestinationUri',
                               '(Landroid/net/Uri;)')]},
    'REBOOT': {
        'Landroid/os/RecoverySystem;': [('F', 'installPackage',
                '(Landroid/content/Context; Ljava/io/File;)'), ('F',
                'rebootWipeUserData', '(Landroid/content/Context;)'),
                ('F', 'bootCommand',
                '(Landroid/content/Context; Ljava/lang/String;)'), ('F'
                , 'installPackage',
                '(Landroid/content/Context; Ljava/io/File;)'), ('F',
                'rebootWipeUserData', '(Landroid/content/Context;)')],
        'Landroid/content/Intent;': [('C', 'IntentResolution',
                'Ljava/lang/String;'), ('C', 'ACTION_REBOOT',
                'Ljava/lang/String;')],
        'Landroid/os/PowerManager;': [('F', 'reboot',
                '(Ljava/lang/String;)'), ('F', 'reboot',
                '(Ljava/lang/String;)')],
        'Landroid/os/IPowerManager$Stub$Proxy;': [('F', 'crash',
                '(Ljava/lang/String;)'), ('F', 'reboot',
                '(Ljava/lang/String;)')],
        },
    'INSTALL_PACKAGES': {'Landroid/app/ContextImpl$ApplicationPackageManager;': [('F'
                         , 'installPackage',
    ...
    'SET_DEBUG_APP': {'Landroid/app/IActivityManager$Stub$Proxy;': [('F'
                      , 'setDebugApp', '(Ljava/lang/String; B B)')]},
    'INSTALL_LOCATION_PROVIDER': {'Landroid/location/ILocationManager$Stub$Proxy;': [('F'
                                  , 'reportLocation',
                                  '(Landroid/location/Location; B)')]},
    'SET_WALLPAPER_HINTS': {'Landroid/app/WallpaperManager;': [('F',
                            'suggestDesiredDimensions', '(I I)')],
                            'Landroid/app/IWallpaperManager$Stub$Proxy;': [('F'
                            , 'setDimensionHints', '(I I)')]},
    'READ_CONTACTS': {
        'Landroid/app/ContextImpl$ApplicationContentResolver;': [('F',
                'openFileDescriptor',
                '(Landroid/net/Uri; Ljava/lang/String;)'), ('F',
                'openInputStream', '(Landroid/net/Uri;)'), ('F',
                'openOutputStream', '(Landroid/net/Uri;)'), ('F',
                'query',
        ...
        'Landroid/provider/ContactsContract$Data;': [('F',
                'getContactLookupUri',
                '(Landroid/content/ContentResolver; Landroid/net/Uri;)'
                )],
        'Landroid/provider/ContactsContract$Contacts;': [('F',
        ...
        'Landroid/pim/vcard/VCardComposer;': [('F', 'createOneEntry',
                '()'), ('F', 'createOneEntry',
                '(Ljava/lang/reflect/Method;)'), ('F',
                'createOneEntryInternal',
                '(Ljava/lang/String; Ljava/lang/reflect/Method;)'), ('F'
                , 'init', '()'), ('F', 'init',
                '(Ljava/lang/String; [L[Ljava/lang/Strin;)')],
        'Landroid/pim/vcard/VCardComposer$OneEntryHandler;': [('F',
                'onInit', '(Landroid/content/Context;)')],
        'Lcom/android/internal/telephony/CallerInfo;': [('F',
                'getCallerId',
                '(Landroid/content/Context; Ljava/lang/String;)'), ('F'
                , 'getCallerInfo',
                '(Landroid/content/Context; Ljava/lang/String;)')],
        'Landroid/provider/Contacts$Settings;': [('F', 'getSetting',
                '(Landroid/content/ContentResolver; Ljava/lang/String; Ljava/lang/String;)'
                )],
        'Landroid/provider/ContactsContract$RawContacts;': [('F',
                'getContactLookupUri',
                '(Landroid/content/ContentResolver; Landroid/net/Uri;)'
                )],
        'Landroid/provider/CallLog$Calls;': [('F', 'addCall',
                '(Lcom/android/internal/telephony/CallerInfo; Landroid/content/Context; Ljava/lang/String; I I J I)'
                ), ('F', 'getLastOutgoingCall',
                '(Landroid/content/Context;)')],
        'Lcom/android/internal/telephony/IIccPhoneBook$Stub$Proxy;': [('F'
                , 'getAdnRecordsInEf', '(I)')],
        'Landroid/pim/vcard/VCardComposer$HandlerForOutputStream;': [('F'
                , 'onInit', '(Landroid/content/Context;)')],
        'Landroid/provider/ContactsContract$CommonDataKinds$Phone;': [('C'
                , 'CONTENT_URI', 'Landroid/net/Uri;')],
        'Landroid/widget/QuickContactBadge;': [('F',
                'assignContactFromEmail', '(Ljava/lang/String; B)'),
    ...
    'BACKUP': {'Landroid/app/backup/IBackupManager$Stub$Proxy;': [
        ('F', 'backupNow', '()'),
        ...
        ('F', 'setBackupEnabled', '(B)'),
            ...
            'Landroid/app/backup/BackupManager;': [('F',
                'beginRestoreSession', '()'), ('F', 'dataChanged',
                '(Ljava/lang/String;)'), ('F', 'requestRestore',
