...
DVM_PERMISSIONS = {'MANIFEST_PERMISSION': {  # MESSAGES
                                             # SOCIAL_INFO
                                             # PERSONAL_INFO
                                             # CALENDAR
                                             # USER_DICTIONARY
    ...
    'SEND_SMS_NO_CONFIRMATION': ['signatureOrSystem',
                                 'send SMS messages',
    ...
    'BIND_DIRECTORY_SEARCH': ['signatureOrSystem',
    ...
    'INTERNET': ['dangerous', 'full Internet access',
    ...
    'CONNECTIVITY_INTERNAL': ['signatureOrSystem',
    ...
    'CHANGE_CONFIGURATION': ['signatureOrSystemOrDevelopment',
    ...
    'SET_ANIMATION_SCALE': ['signatureOrSystemOrDevelopment',
    ...
    'MOUNT_UNMOUNT_FILESYSTEMS': ['signatureOrSystem',
                                  'mount and unmount file systems',
                                  'Allows the application to mount and unmount file systems for removable storage.'
                                  ],
    'MOUNT_FORMAT_FILESYSTEMS': ['signatureOrSystem',
    ...
    'WRITE_APN_SETTINGS': ['signatureOrSystem',
    ...
    'VIBRATE': ['normal', 'control vibrator',
                'Allows the application to control the vibrator.'],
    'FLASHLIGHT': ['normal', 'control flashlight',
    ...
    'RECORD_AUDIO': ['dangerous', 'record audio',
    ...
    'READ_PRIVILEGED_PHONE_STATE': ['signatureOrSystem',
    ...
    'SET_WALLPAPER': ['normal', 'set wallpaper',
    ...
    'SET_TIME_ZONE': ['normal', 'set time zone',
    ...
    'DUMP': ['signatureOrSystemOrDevelopment',
    ...
    'READ_LOGS': ['signatureOrSystemOrDevelopment',
    ...
    'SET_DEBUG_APP': ['signatureOrSystemOrDevelopment',
    ...
    'SET_PROCESS_LIMIT': ['signatureOrSystemOrDevelopment',
    ...
    'SET_ALWAYS_FINISH': ['signatureOrSystemOrDevelopment',
    ...
    'SIGNAL_PERSISTENT_PROCESSES': ['signatureOrSystemOrDevelopment',
    ...
    'SET_TIME': ['signatureOrSystem', 'set time',
    ...
    'STATUS_BAR_SERVICE': ['signature', 'status bar',
    ...
    'MAGNIFY_DISPLAY': ['signature', '',
                        'Allows an application to magnify the content of a display.'
                        ],
    ...
    'CONFIGURE_WIFI_DISPLAY': ['signature', '',
    ...
    'PACKAGE_USAGE_STATS': ['signatureOrSystem',
    ...
    'MANAGE_NETWORK_POLICY': ['signature',
    ...
    'MODIFY_NETWORK_ACCOUNTING': ['signatureOrSystem',
    ...
    'ACCESS_USB': ['signatureOrSystem', 'access USB devices',
